...
static std::string MakeKeyID(const std::string& sessionID, ::mls::CipherSuite suite)
{
...
static std::map<std::string, std::shared_ptr<::mls::SignaturePrivateKey>> map;

namespace discord {
namespace dave {
namespace mls {

static std::shared_ptr<::mls::SignaturePrivateKey> GetPersistedKeyPair(
...
std::shared_ptr<::mls::SignaturePrivateKey> GetPersistedKeyPair(KeyPairContextType ctx,
                                                                  const std::string& sessionID,
